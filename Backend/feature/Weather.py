...
class Weather:
    ...
    def weather_forecast(self, time, place):
        ...
        listWorld = ['東京', '大阪', '首爾', '曼谷', '雅加達', '吉隆坡', '新加坡', '馬尼拉', '胡志明市', '河內', 
                     '海參威', '伯力', '關島', '檀香山', '威靈頓', '奧克蘭', '雪梨機場', '伯斯', '布里斯班', '瀋陽', 
                     '青島', '北京', '南京', '開封', '蘭州', '武漢', '重慶', '昆明', '上海', '南昌', 
                     '杭州', '廣州', '福州', '香港', '海口', '西安', '墨爾本', '雪梨', '洛杉磯', '拉斯維加斯', 
                     '舊金山', '西雅圖', '紐約', '華盛頓', '芝加哥', '邁阿密', '多倫多', '溫哥華', '蒙特婁', '墨西哥城', 
                     '里約', '聖地牙哥', '利瑪', '布宜諾斯艾利斯', '奧斯陸', '馬德里', '哥本哈根', '赫爾辛基', '法蘭克福', '柏林', 
                     '日內瓦', '布魯塞爾', '倫敦', '巴黎', '維也納', '羅馬', '威尼斯', '布達佩斯', '雅典', '華沙', 
                     '布拉格', '阿姆斯特丹', '斯德哥爾摩', '里斯本', '開羅', '約翰尼斯堡', '加德滿都', '新德里', '伊斯坦布爾', '莫斯科']

        
        listTaiwanEnglish = ['Hsinchu County', 'Kinmen County', 'Miaoli County', 'New Taipei City', 'Yilan County', 'Yunlin County', 'Tainan City', 'Kaohsiung City', 'Changhua County', 
