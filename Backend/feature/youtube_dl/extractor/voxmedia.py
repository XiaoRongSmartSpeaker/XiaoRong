    ...
    def _real_extract(self, url):
        ...
        for provider_video_type in ('ooyala', 'youtube', 'brightcove'):
            ...
            if provider_video_type == 'brightcove':
                ...
                info.update({'_type': 'url_transparent', 'url': provider_video_id if provider_video_type == 'youtube' else '%s:%s' % (
                    provider_video_type, provider_video_id), 'ie_key': provider_video_type.capitalize(), })
            return info
