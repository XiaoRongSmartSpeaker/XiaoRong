...
class SBSIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        theplatform_url = (urls.get('progressive') or urls.get(
            'html') or urls.get('standard') or player_params['relatedItemsURL'])

        return {'_type': 'url_transparent',
                'ie_key': 'ThePlatform',
                'id': video_id,
                'url': smuggle_url(self._proto_relative_url(theplatform_url),
                                   {'force_smil_url': True}),
                }
