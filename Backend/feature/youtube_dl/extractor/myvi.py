...
class MyviIE(SprutoBaseIE):
    ...
    _TESTS = [{'url': 'http://myvi.ru/player/embed/html/oOy4euHA6LVwNNAjhD9_Jq5Ha2Qf0rtVMVFMAZav8wObeRTZaCATzucDQIDph8hQU0',
               ...
               'info_dict': {'id': 'f16b2bbd-cde8-481c-a981-7cd48605df43',
                             'ext': 'mp4',
                             'title': 'хозяин жизни',
    ...
    def _real_extract(self, url):
        ...
        spruto = self._download_json(
            'http://myvi.ru/player/api/Video/Get/%s?sig' %
            video_id, video_id)['sprutoData']
...
class MyviEmbedIE(InfoExtractor):
    ...
    def suitable(cls, url):
        return False if MyviIE.suitable(url) else super(
            MyviEmbedIE, cls).suitable(url)
