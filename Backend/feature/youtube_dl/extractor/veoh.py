...
class VeohIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.veoh.com/watch/v56314296nk7Zdmz3',
               'md5': '9e7ecc0fd8bbee7a69fe38953aeebd30',
               'info_dict': {'id': 'v56314296nk7Zdmz3',
                             'ext': 'mp4',
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            'uploader': video.get(
                ...
                {}).get('nickname'),
            'duration': int_or_none(
                video.get('lengthBySec')) or parse_duration(
                video.get('length')),
            'view_count': int_or_none(
                video.get('views')),
            'formats': formats,
