...
ServerPath = "https://7575-140-122-136-85.ngrok.io/"
...
class Delivery:
    ...
    def deliver_to_cellphone(self, resultURL, keyWord):
        # 把東西給server
        # 拿音箱上的使用者id，伺服器那邊會根據這個找到對應的LINEId
        userId = ""
        r = requests.post(
...
class Memorandum:
    ...
    def memorandum(self, file_name):
        ...
        # 拿音箱上的使用者id，伺服器那邊會根據這個找到對應的LINEId
        userId = ""
        memorandum.deliver_memorandum(file_name, userId, timeLen)
        # return 0
